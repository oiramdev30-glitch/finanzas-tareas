...
export const DAY_SHORT = ['D', 'L', 'M', 'Mi', 'J', 'V', 'S'];
...
function readStored(): ScheduledReminder[] | null {
...
function persist(items: ScheduledReminder[]): void {
  try {
...
interface ReminderState {
  ...
  loaded: boolean;
  load: () => void;
  add: (input: ReminderInput) => ScheduledReminder | null;
  update: (id: string, input: ReminderInput) => boolean;
